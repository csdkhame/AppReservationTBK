                ...
                <div class="col-sm-8 col-sm-offset-2" style="padding: 0">
                    ...
                    <div class="wizard-container">
                        ...
                        <!--        You can switch " data-color="purple" "  with one of the next bright colors: "green", "orange", "red", "blue"       -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-7 col-sm-offset-1" id="box-detail-price" >                                  
                                                        ...
                                                        <p style="">
                                                            <span >Type:</span>
                                                           &nbsp;&nbsp;
                                                            <span ng-if="flagcheck == 1" id="cars_persion">Van Vip Ventury(1-7 Pax) </span>
                                                            
                                                        </p>
                                                        <p class="prices">
                                                            <span ng-if="flagcheck == 1">Price: </span>
                                                            
                                                            <span style="color: #fb833f;" id="price">&nbsp;</span>
                                                        </p>
                                                        <p class="sumprice">
                                                            <span ng-if="flagcheck == 1">Total prices :</span>
                                                             &nbsp; &nbsp;
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <div class='input-group date' id='datetimepicker11'>
                                                    <input type='text' class="form-control" id="on_date"  name="on_date" value="on_date" aria-required="true" aria-invalid="true" required>
                                ...
                                <div class="show-time">
                                    ...
                                    <table width="100%">
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        <td width="49%" align="center">
                                                            <select class="form-control form-inline time_h" style="width: 100%;padding: 0 30px;" id="time_h" name="time_h">
                                                        ...
                                                        <td width="49%" align="center">
                                                             <select class="form-control form-inline time_m" style="width: 100%;padding: 0 30px;" id="time_m" name="time_m" required>
                                        ...
                                        <!-- <p id="title-around">
                                          ...
                                          <div class="row">
                                          <div class="form-person col-md-12">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td width="80%">
                                                    <table width="100%">
                                                        <tr >
                                                            <td align="center">
                                                            <select class="form-control form-inline" id="num_cars"  name="num_cars" style="width: 100%" required>
                                ...
                                <div class="row">
                                    <div class="form-person col-md-12" style="">
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select class="form-control" id="num_adult" name="num_adult"  style="" required>
                                                ...
                                                <td>
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select class="form-control" id="num_child" name="num_child" style="" required>
                                                                    <option value="0">0</option>
                                                                    <option value="1">1</option>
                                                                    <option value="2">2</option>
                                                                    <option value="3">3</option>
                                ...
                                <div class="row">
                                          ...
                                          <div class="col-md-6">
                                                      ...
                                                      <div class="contact_info">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group label-floating">
                                                                    ...
                                                                    <input type="text" class="form-control"  id="name_lastname" name="name_lastname"  pattern="^[A-z ก-ฮ]+$" required>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                            ...
                                                            <div class="form-group label-floating" style="margin-top: 20px">
                                                                ...
                                                                <input type="text" class="form-control" id="phone"  aria-required="true" aria-invalid="true" required>
                                                            </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <div class="contact_info">
                                                <div class="col-sm-12">
                                                    <div class="form-group label-floating" id="media-email" style="">
                                                        <label class="control-label">E-mail</label>
                                                        <input type="email" class="form-control" id="email" aria-required="true" aria-invalid="true" required>
                                                    </div>
                                                </div>
                    ...
                    <div class="box-list-summery">
                       <div >
                               ...
                               <div >
                                    ...
                                    <span style="color: #fb833f;" id="adultsummary"></span><span>:</span>
                            ...
                            <input type="checkbox" name="chickenEgg" value="checked" ng-model="state" ng-click="Acceptance($event,state)" class="ng-pristine ng-untouched ng-valid">&nbsp;&nbsp;
                                ...
                                <div class="wizard-footer">
                                    <div class="pull-right">
                                        ...
                                        <input type='button' class='btn btn-fill btn-warning btn-wd' id="addbook" value='Book' style="display: none; " />
                                    </div>
